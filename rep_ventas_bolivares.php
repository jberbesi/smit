  		...
  		<tr> 
    		<td colspan="5" rowspan="2" valign="top"> 
      			<table width="600" border="0" align="center">
        			...
        			<?php if (is_null(mysqli_fetch_row($query))) {?>
        			<tr>
        				<table align="center">
        					<tr>
        						<td>&nbsp;</td>
        			...
        			<?php $cont = $cont + 1; 
        			echo(colorFondo($cont));}?>
        			<tr> 
          <td width="145" height="34" align="right" valign="middle" class="Negro"><div align="center"><a href"#" style="cursor:hand;" onClick="javascript:print();"><img src="img/print.png" border="0" align="top"></a></div></td>
          <td width="143" align="right" class="Negro"> <div align="center"><a href"#" style="cursor:hand;" onClick="?>javascript:window.close();"><img src="img/cerrar.png"  border="0" align="top"></a></div></td>
        </tr><?php }?>
        		</table>
        	</td>
        </tr>
