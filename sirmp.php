...
<!-- #INCLUDE FILE="conexion.asa"-->
<%If Session("userml") = "" then
	%><script type="text/javascript">
		window.location = "default.asp"
	</script><%
End If
vuser = Session("nombre_usuario")
Server.ScriptTimeout = 2500 
AbrirConexion
  sql = "SELECT UrlEmpresaBackground FROM SOS_Parametros"  
  set rst= Server.CreateObject("adodb.recordset")
  set rst=cn.execute(sql)  
  if not (rst.EOF) then 
	  with rst	        
	           logo = .Fields("UrlEmpresaBackground")    
	  End with  
  End if  
%><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <table style="width: 100%; height: 700px" cellspacing="0" cellpadding="0" align="center">
			<tr>
				...
				<table cellspacing="0" cellpadding="0">
					<tr>
						<td align="center" height="120"><a target="contenido" href="123/default.asp"><img alt=""  src="<%=logo%>"></a></td>
					</tr>
					<tr>
				...
				<table width="1150" align="center" cellpadding="0" cellspacing="0" style="height: 140px;">
					<tr>
						<td align="center">				
						<table width="100%" align="center" style="width: 100%; height: 45px;">
							<tr>
								<td align="left" style="height: 22px">
								<span class="style13"><b> User:</b> <%=vuser%></span><br> 
