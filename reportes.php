...
<table width="800" border="0" align="center">
	<tr>
		<td width="664" height="399"> 
          ...
          <tr>
            <td width="339" height="42" class="negro"><img src="img/rojo.gif"><a href="#" style="cursor:hand; font-size: 12px;" class="revista1" onClick="javascript:verificar('rep_ventas_bolivares',document.frm_reportes.mes.value,document.frm_reportes.ano.value, document.frm_reportes.vendedor.value,document.frm_reportes.idnumber.value);return;"> Ventas En Bolivares</a></td>
